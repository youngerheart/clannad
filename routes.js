...
router.post('/admin/project', Auth.isAdmin, Project.add);
...
// 查询某项目的表列表
router.get('/admin/:projectName/list', Table.list);

// 查询某项目的表总和
router.get('/admin/:projectName/list/count', Table.count);
...
// 查询某表详情
router.get('/admin/:projectName/table/:id', Table.get);
...
// 用户接口
router.use(['/:projectName/:tableName', '/:projectName/:tableName/:id'], Auth.isUser, Table.getSchema);
...
// 获得单条资源
router.get('/:projectName/:id', Source.get);
