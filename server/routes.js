...
// 用户接口
router.post('/admin/:project/:collection', Auth.isUser, Source.add);
router.del('/admin/:project/:collection/:id', Auth.isUser, Source.del);
router.put('/admin/:project/:collection/:id', Auth.isUser, Source.edit);
router.get('/admin/:project/:collection', Auth.isUser, Source.list);
router.get('/admin/:project/:collection/count', Auth.isUser, Source.count);
router.get('/admin/:project/:collection/:id', Auth.isUser, Source.get);
